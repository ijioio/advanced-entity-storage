...
public class PropertyByteArrayCreatePersistenceTest
	...
	protected String getSqlScriptFileName() {
		return "property-byte-array-create-persistence.sql";
	}

	@Override
	protected String getTableName() {
		return PropertyByteArrayCreatePersistenceIndex.class.getSimpleName();
	}
	...
	protected void checkPropertyValue(byte[] value, ResultSet resultSet) throws Exception {
		Assertions.assertArrayEquals(value, getBytes(resultSet.getBlob("valueByteArray")));
	}
}
