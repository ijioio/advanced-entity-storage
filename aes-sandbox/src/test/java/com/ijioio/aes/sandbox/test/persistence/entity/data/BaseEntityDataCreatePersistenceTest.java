...
public abstract class BaseEntityDataCreatePersistenceTest<E extends Entity> extends BasePersistenceTest {

	public static class Some extends BaseEntity {

		public static final String NAME = "com.ijioio.aes.sandbox.test.persistence.entity.data.BaseEntityDataCreatePersistenceTest.Some";
	}
